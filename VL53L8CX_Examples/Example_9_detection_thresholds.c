...
int example9(void)
{
	...
	uint8_t 				status, isAlive, isReady, resolution, i;
	uint8_t					loop;
	...
	*/
	...
	for(i = 0; i < resolution; i++){
		 ...
		 * checker to this one.
		 * For this example, distance thresholds are set between 50mm and
		 * 100mm (the format is automatically updated inside driver).
		 */
	...
	thresholds[resolution * 2 -1 ].zone_num = VL53L8CX_LAST_THRESHOLD | thresholds[resolution * 2 -1].zone_num;
